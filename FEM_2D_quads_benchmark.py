...
class FEM_2D_element_quad:
    ...
    def __init__(self, n_elem, *args):
        ...
        self.v = args[4]
        self.n_elem = n_elem
        self.Le =(self.L)/(self.n_elem) # number of horizontal divisions (2 triangles make 1 quad)
...
#
    ...
    def check_symmetric(self, tol=1e-5):
...
def main():
 number_elements, Length, Height, q_load = 1,3,2,-225
